 ...
 */
final class Version20240620073527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE modele (id INT AUTO_INCREMENT NOT NULL, typ VARCHAR(255) NOT NULL, nazwa VARCHAR(255) NOT NULL, producent VARCHAR(255) NOT NULL, system_operacyjny VARCHAR(50) DEFAULT NULL, cpu VARCHAR(255) DEFAULT NULL, ram VARCHAR(20) DEFAULT NULL, dysk INT DEFAULT NULL, przeznaczenie VARCHAR(255) DEFAULT NULL, ilosc_ogolna INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, product_name VARCHAR(100) NOT NULL, product_id INT NOT NULL, price VARCHAR(50) NOT NULL, quantity INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
